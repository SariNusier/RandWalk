...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "saveData".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SaveData#execute()} method to invoke the remote operation.
   *
   * @param data
   * @param score
   * @return the request
   */
  public SaveData saveData(java.lang.String data, java.lang.Integer score) throws java.io.IOException {
    SaveData result = new SaveData(data, score);
    initialize(result);
    return result;
  }

  public class SaveData extends MyApiRequest<com.example.sari.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "saveData/{data}/{score}";

    /**
     * Create a request for the method "saveData".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SaveData#execute()} method to invoke the remote operation. <p>
     * {@link
     * SaveData#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     ...
     * @since 1.13
     */
    protected SaveData(java.lang.String data, java.lang.Integer score) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.sari.backend.myApi.model.MyBean.class);
    ...
    @Override
    public SaveData setAlt(java.lang.String alt) {
      return (SaveData) super.setAlt(alt);
    }

    @Override
    public SaveData setFields(java.lang.String fields) {
      return (SaveData) super.setFields(fields);
    }

    @Override
    public SaveData setKey(java.lang.String key) {
      return (SaveData) super.setKey(key);
    }

    @Override
    public SaveData setOauthToken(java.lang.String oauthToken) {
      return (SaveData) super.setOauthToken(oauthToken);
    }

    @Override
    public SaveData setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SaveData) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SaveData setQuotaUser(java.lang.String quotaUser) {
      return (SaveData) super.setQuotaUser(quotaUser);
    }

    @Override
    public SaveData setUserIp(java.lang.String userIp) {
      return (SaveData) super.setUserIp(userIp);
    }
    ...
    public SaveData setData(java.lang.String data) {
      this.data = data;
      return this;
    }
    ...
    public SaveData setScore(java.lang.Integer score) {
      this.score = score;
      return this;
    }

    @Override
    public SaveData set(String parameterName, Object value) {
      return (SaveData) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.sari.backend.myApi.model.MyBean> {
